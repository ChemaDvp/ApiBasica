package com.JoseManuelMartinez.demo.controller;

import com.JoseManuelMartinez.demo.dto.PlayerDTO;
import com.JoseManuelMartinez.demo.persistence.model.Player;
import com.JoseManuelMartinez.demo.services.PlayerServiceImp;
...
public class ProductController {
    ...
    private Player convertirDTOaJugador(PlayerDTO playerDTO) {
        return new Player(playerDTO.getName(), playerDTO.getPosition(), playerDTO.getClubName(), playerDTO.getImageURL());
    }
